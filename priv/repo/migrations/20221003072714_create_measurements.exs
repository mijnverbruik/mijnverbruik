defmodule Mijnverbruik.Repo.Migrations.CreateMeasurements do
  ...
  def change do
    create table(:measurements, primary_key: false) do
      ...
      add :electricity_currently_delivered, :numeric, precision: 9, scale: 3
      add :electricity_currently_returned, :numeric, precision: 9, scale: 3
      ...
      add :mbus_channel_1_measured_at, :naive_datetime
      ...
      add :mbus_channel_2_measured_at, :naive_datetime
      ...
      add :mbus_channel_3_measured_at, :naive_datetime
      ...
      add :mbus_channel_4_measured_at, :naive_datetime
