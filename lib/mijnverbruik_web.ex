defmodule MijnverbruikWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: MijnverbruikWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/mijnverbruik_web/templates",
        namespace: MijnverbruikWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {MijnverbruikWeb.LayoutView, "live.html"}
